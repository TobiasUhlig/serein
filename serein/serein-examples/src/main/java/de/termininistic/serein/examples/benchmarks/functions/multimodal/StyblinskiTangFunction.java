...
public class StyblinskiTangFunction implements BenchmarkFunction {
	
	public final static Domain DEFAULT_DOMAIN = new Domain(-5, 5);
	...
	public StyblinskiTangFunction(Domain domain) {
		this.domain = domain;
	}
