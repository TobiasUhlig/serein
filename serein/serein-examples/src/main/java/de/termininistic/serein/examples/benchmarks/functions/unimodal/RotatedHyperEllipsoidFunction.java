...
public class RotatedHyperEllipsoidFunction implements BenchmarkFunction {
	public final static Domain DEFAULT_DOMAIN = new Domain(-65.536, 65.536);
	private final Domain domain;
	
	public RotatedHyperEllipsoidFunction() {
		this(DEFAULT_DOMAIN);
	}
	
	public RotatedHyperEllipsoidFunction(Domain domain) {
		this.domain = domain;
	}
